...
\todo[inline]{Subsection missing here}
\label{del:CCG}
...
\paragraph*{Significance tests.}\todo{\textbackslash paragraphs are not used in the LangSci template. Please find another way to display this text}
