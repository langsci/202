...
\todo[inline]{Italics or small caps for terms in this par?}MWEs pose \textit{challenges} for all areas of NLP, and \isi{statistical parsing} is not an exception.
...
Another way of representing MWEs is to annotate them as \textit{subtrees} made of several nodes of the syntactic tree. Many \isi{treebanks} using such representations can be found in \citet{rosen:2015}. Several types of subtree MWE representations were proposed in \isi{treebanks}, according to the language, MWE type and syntactic formalism.
...
%
\textit{... he did not see the traffic\_N light\_V} 
%
