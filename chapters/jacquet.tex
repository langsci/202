...
nutshell, the algorithm collects acronym\slash expansion pairs (such as
...
\midrule
cluster 1  & \itshape  Social-Democratic Party      &  SDP  & en  \\
           & \itshape  Social Democratic Party      &      &     \\ \midrule
cluster 2  & \itshape  Partito Social-Democratico   &  PSD  & it \\
...
\textit{InvEdit}, which corresponds to the inverse of the normalized
...
%                     ylabel=\%,
                    ...
                    reverse legend,
                    legend style={at={(0.5,-0.1)},anchor=north,font=\scriptsize\scshape,legend columns=-1},
                    legend cell align=left,
                    ]
            \foreach \i in {1,...,\numberofcols} {
                \addplot+[
