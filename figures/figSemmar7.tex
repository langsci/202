...
% First sentence
\hnode{w1S}{What role will} & 
\hnode{t2S}{the} & 
\hnode{i3S}{Indonesian armed forces play}  &
\\
...
\hnode{q1T}{Quel sera} & 
\hnode{l2T}{le} & 
\hnode{r3T}{rôle des forces armées indonésiennes} & 
\\
};

% Now connect the nodes.  For paths that we want to break, name the path
\draw (w1S.south) -- (q1T.north);
\draw (t2S.south) -- (l2T.north);
\draw (i3S.south) -- (r3T.north);
