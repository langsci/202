...
% First sentence
\hnode{p1S}{Prison conditions of} & 
\hnode{p2S}{political prisoners} & 
\hnode{i3S}{in Djibouti} & 
\\
...
% Second sentence
\hnode{c1T}{Conditions de détention des} & 
\hnode{p2T}{prisonniers politiques} & 
\hnode{a3T}{à Djibouti} & 
\\
};

% Now connect the nodes.  For paths that we want to break, name the path
\draw (p1S.south) -- (c1T.north);
