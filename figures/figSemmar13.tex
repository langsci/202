...
% First sentence
\hnode{a1S}{A guilty verdict is} & 
\hnode{i2S}{irrelevant to this request} &  
\\
...
% Second sentence
\hnode{l1T}{La requête fait abstraction} & 
\hnode{d2T}{du jugement sur la culpabilité} & 
\\
};

% Now connect the nodes.  For paths that we want to break, name the path
\draw (a1S.south) -- (d2T.north);
\draw (i2S.south) -- (l1T.north);
